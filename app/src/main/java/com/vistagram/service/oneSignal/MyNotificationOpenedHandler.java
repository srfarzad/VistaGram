package com.vistagram.service.oneSignal;
    ...
    public void notificationOpened(OSNotificationOpenResult result) {
        ...
        if (data != null) {
            ...
            if (activityToBeOpened != null && activityToBeOpened.equals("AnotherActivity")) {
                ...
                Intent intent = new Intent(AppConfiguration.getContext(), MainActivity.class);
        ...
        if (actionType == OSNotificationAction.ActionType.ActionTaken) {
            ...
            if (result.action.actionID.equals("ActionOne")) {
                Toast.makeText(AppConfiguration.getContext(), "ActionOne Button was pressed", Toast.LENGTH_LONG).show();
            } else if (result.action.actionID.equals("ActionTwo")) {
                Toast.makeText(AppConfiguration.getContext(), "ActionTwo Button was pressed", Toast.LENGTH_LONG).show();
            }
        }
    }
}